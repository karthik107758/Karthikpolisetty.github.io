# Lincoln Financial Group: ETL Automation, Cloud Migration, and Data Governance

## Role: MicroStrategy and Informatica Consultant / ETL and Report Developer
## Timeline: April 2022 – April 2025
## Focus: Automating data ingestion via Python APIs, leading cloud migration of BI infrastructure, and ensuring data integrity for financial reporting.

## 🛠️ Technical Implementation

|System Component|Technologies Used|Description|
| :--- | :--- | :--- |
|ETL Automation|Python, Informatica, Oracle|Developed and owned the full lifecycle of the Performance Guarantees initiative, utilizing Python scripts for dynamic API calls.|
|Data Ingestion|Qualtrics API, Informatica Mappings|Engineered highly efficient, API-driven Python scripts to pull Qualtrics survey data and integrate it into Oracle tables via Informatica mappings.|
|BI Architecture|MicroStrategy (On-Prem to Cloud), Power BI|Led the cloud migration of the on-premises MicroStrategy environment.|
